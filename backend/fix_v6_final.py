...
for i, line in enumerate(lines):
    if line.startswith('def _expand_rooms_v6'):
        start_v6 = i
    if line.startswith('def _expand_rooms_v4') and start_v6 != -1:
        end_v6 = i
        break

if start_v6 == -1 or end_v6 == -1:
    print('Failed to find V6')
    sys.exit(1)
...
new_lines = lines[:start_v6] + [v6_code, '\n'] + lines[end_v6:]

with open(file_path, 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print('V6 perfectly rewritten!')
